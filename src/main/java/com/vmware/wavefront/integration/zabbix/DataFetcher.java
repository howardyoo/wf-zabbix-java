 ...
 */
public class DataFetcher extends DataRunner implements Runnable {
    ...
    public void run() {
        System.out.println(Thread.currentThread().getName()+" Start. Command = " + getCommand());
        processCommand();
    ...
    private void processCommand() {
        try {
            ...
            System.out.println(Thread.currentThread().getName() + " delay " + delay + "ms..");
            ...
            */
            ...
            System.out.println("["+ tableName +"] total number of metrics between " + start + "~" + end + " : " + metrics + " points");
